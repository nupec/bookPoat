...
HR – 1) descrição sucinta do roteiro metodológico na construção dos dashboards:
Referência aos softwares usados, suas funções e limitações (R e Power BI)
Rotinas operacionalizadas e explicitação das narrativas (gerais e específicos)
Articulação com as fontes selecionadas e respetiva estruturação
[definir formalmente o conceito de dashboard (ver artigos a respeito) e explicar a escolha da ferramenta escolhida]

### Diagnóstico do (in)sucesso escolar

**Cofinanciamentos PIICIE**  

**Tendências e padrões no sucesso**  

A recolha de informação e o tratamento de bases de dados com os indicadores gerais de resultado dos PIICIE, aqui utilizados na identificação de tendências e padrões territoriais sobre o (in)sucesso escolar, tiveram como objetivo primordial a construção de *dashboards* que contribuíssem para a leitura dessas dinâmicas de forma mais expedita e interativa.  
O diagnóstico de tendências e padrões foi desenvolvido para os municípios da NUTS II e NUTS III de referência da unidade territorial de estudo, o município de Santa Maria da Feira – para a totalidade de municípios da Região Norte no que às taxas de retenção e desistência diz respeito e unicamente para os da Área Metropolitana do Porto (AMP) no que se refere às taxas de níveis negativos a pelo menos uma disciplina. Duas análises foram desenvolvidas na elaboração deste retrato:  


   - Uma análise estatística inicial de ambos os indicadores gerais de resultado indicados no aviso de candidatura dos PIICIE; e
   - Uma análise de **similaridades combinando os indicadores gerais de resultado com outros indicadores de caracterização socioeducativa relevantes na definição de *clusters* territoriais.** Numa primeira fase, os clusters apresentados resultam do reconhecimento de semelhanças entre os município da AMP, partindo da análise de 4 indicadores em valores absolutos entre 2014/15 e 2018/19 ou 2017/18 e 2018/19: i) alunos com níveis negativos a pelo menos uma disciplina, ii) alunos retidos, iii) alunos inscritos/alunos da amostra e iv) alunos com apoio da ação social escolar (ASE) [^1]. Numa segunda fase, as similaridades entre municípios são estabelecidas à escala da Região Norte de acordo com a análise de 3 indicadores em valores relativos para 2017/18 e 2018/19: i) taxas de retenção e desistência (País), ii) equidade [^2] e iii) quociente entre financiamento PIICIE [^3] e alunos inscritos por níveis de ensino.  

![](C:\Users\julio\Downloads\quadro1.jpg)  

[^1]: **Alunos c/ASE** - Os dados utilizados dizem apenas respeito ao nº absoluto de alunos com ASE considerado na amostra, de acordo com a informação disponibilizada no PORTAL INFOESCOLAS.
[^2]: **Indicador de Equidade** - “Diferença entre a % de conclusão no tempo esperado na região e a média nacional comparável, em pontos percentuais.” A média nacional “é calculada com os alunos do país que, ao entrarem no 3.º ciclo, tinham um perfil semelhante ao dos alunos da região, em termos de apoios ASE, idade à entrada no ciclo, habilitação da mãe e categoria da escola frequentada relativamente à percentagem de alunos com apoio ASE. O objetivo é enquadrar os resultados dos alunos com apoio ASE na região com uma média nacional apropriada.”  
**Fonte:** PORTAL INFOESCOLAS / Produção dos indicadores: DGEEC/Medu. https://infoescolas.medu.pt/bds.asp  
[^3]: **Indicador do Quociente entre financiamento PIICIE e Alunos Inscritos por níveis de ensino** - Para os valores de financiamento, apenas é considerado o fundo total aprovado em €. Este indicador foi calculado pela equipa.  
**Fonte:** Financiamento PIICIE - Projetos Aprovados nos PO Reginais, de acordo com a base de dados atualizada a 31/08/2021 / Alunos Inscritos por níveis de ensino - DGEEC.

![](C:\Users\julio\Downloads\quadro2.jpg)
...
A opção de analisar as taxas de retenção e desistência enquanto indicador geral de resultado dos PIICIE, na catação de possíveis fatores de sucesso, decorreu do facto da informação estar disponível para todos os municípios da Região Norte, enquanto para as taxas de níveis negativos a pelo menos uma disciplina só foi possível aceder a dados para os municípios da AMP com igual desagregação. A análise reporta a 2018/19, tendo sido realizada para o ensino básico (1º, 2º e 3º CEB) e secundário das escolas públicas agrupadas.[^4] Em municípios com mais de um agrupamento de escolas (AE), os dados foram agregados.  
Na base da seleção das variáveis independentes, assumiu-se como critério chave a sua relevância para a leitura espacial, demográfica, socioeconómica e socioeducativa dos territórios a analisar, com desagregação até ao município. No total, foram consideradas 16 variáveis explicativas[^5]:

[^4]: Para consulta da respetiva fonte, ver Quadro 1. 
[^5]: A informação utilizada tem origem em bases de dados abertas do PORDATA (variáveis recolhidas – densidade populacional, nº de estabelecimentos de ensino ativos em cada nível, população que completou o ensino secundário e o ensino superior, poder de compra per capita) e Infoescolas (variáveis recolhidas – equidade e percentagem de alunos com ASE que concluíram os níveis de ensino básico e secundário nos anos previstos).
...
![](C:\Users\julio\Downloads\figura1.jpg)  
Na Figura 1 esquematiza as três principais etapas da análise de autocorrelação espacial desenvolvida[^6]:
...
[^6]: Para maior detalhe, consultar o ponto 2.3.

### Desconstrução do PIICIE de SMF

![](C:\Users\julio\Downloads\figura2.jpg)  
![](C:\Users\julio\Downloads\figura3.jpg)
...
![](C:\Users\julio\Downloads\figura4.jpg)

Por outro lado, há ações que têm uma abrangência de público declaradamente alargada, como a Ação 2 – Vive as Férias ou, no limite, a Ação 3 – Observatório, cuja plataforma de consulta pública deveria ser visitada por todos os munícipes que assim desejassem. Por outro lado, a Ação 1 – Equipa Multidisciplinar compreende um rigoroso processo de seleção dos alunos a incluir nas atividades; a Ação 6 – Hora de Experimentar destina-se a alunos de apenas 4 dos 9 Agrupamentos de Escolas[^7].  

[^7]: Sublinhe-se, desde já, que a Hora de Experimentar foi alargada aos restantes Agrupamentos de Escolas, ainda que sem cofinanciamento europeu, sendo as despesas assumidas pela autarquia.  

### Acessos, consulta e divulgação
